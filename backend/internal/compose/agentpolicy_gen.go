...
var agentPolicies = map[string]agentPolicy{
	...
	"DELETE /v1/installation/google-app":                                 {Op: "deleteGoogleApp", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
	...
	"GET /v1/installation/google-app":                                    {Op: "getGoogleApp", Access: "human-only", Tool: "", RecordType: "", Tier: "", Scope: ""},
